...
[![Go Report Card](https://goreportcard.com/badge/github.com/YOUR_USERNAME/YOUR_REPONAME)](https://goreportcard.com/report/github.com/Lartg/makesite)
...
- [x] Run `go run makesite.go` to test in your local directory.
- [x] **Add, commit, and push to GitHub**.
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the google translate library. The documentation is located at https://github.com/bregydoc/gtranslate. My goal is to use it to Japanese.`
- [x] **Add, commit, and push to GitHub**.
